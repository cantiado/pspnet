<template>
  <div class="w-full grid place-content-center">
    <div v-if="!good_msg" class="max-w-xs">
      ...
      <h2 class="text-1xl text-center"> Password reset instructions will be sent to you by email</h2>
    ...
    <div v-if="good_msg" class="max-w-md">
      ...
      <EmailSuccess message="Success! Check your Email for password reset instructions"></EmailSuccess>
