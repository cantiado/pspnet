...
<template>
  <div class="w-full max-h-[79.5vh] flex flex-col justify-start items-center gap-3 p-5 overflow-auto">
    ...
    <div class="w-full flex flex-col gap-3 border-4 border-[#663300] rounded-md p-3">
